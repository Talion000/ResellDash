...
2. Clique **"New query"**
3. Ouvre le fichier `supabase\_schema.sql` fourni
...
4. Avant de valider, clique sur **"Environment Variables"** et ajoute :
   ...
   * `VITE\_SUPABASE\_URL` → colle ta Project URL
   * `VITE\_SUPABASE\_ANON\_KEY` → colle ta anon public key
